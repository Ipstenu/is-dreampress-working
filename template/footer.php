	<footer class="page-footer section--dark">
	<ul class="page-footer-nav list-unset cf">
		...
		<li class="page-footer-nav__column">
			<h5 class="page-footer-nav__headline">Sign In</h5>
			<ul class="page-footer-nav__link-list list-unset">
				<li><a href="https://panel.dreamhost.com">Web Hosting</a></li>
				<li><a href="https://dashboard.dreamcompute.com">DreamCompute</a></li>
				<li><a href="http://webmail.dreamhost.com">Web Mail</a></li>
			</ul>
		</li>
		<li class="page-footer-nav__column">
		...
		<li class="page-footer-nav__column">
			<h5 class="page-footer-nav__headline">Support</h5>
			<ul class="page-footer-nav__link-list list-unset">
	...
	<div class="page-footer-text">
		<p class="page-footer-text--size-large page-footer-text--color-accent page-footer-text--weight-light">Proudly hosting over <span class="page-footer-text--color-default">1,500,000</span> websites since 1997</p>
		<p class="page-footer-text--size-small page-footer-text--color-accent">Copyright &copy; <?php echo date( "Y" ); ?> DreamHost Inc.</p>
	</div>
</footer>

	<script>
		var promoUrl = "//signup.dreamhost.com/?p=";
	</script>
